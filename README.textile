...
hbase-ec2 is a "Ruby":http://ruby-lang.org library to help manage a set of 
"Amazon EC2":http://aws.amazon.com/ instances as a single 
"HBase":http://hbase.apache.org cluster.
...
and "cloud" serving stores. It can support HBase, Cassandra, MongoDB, PNUT, 
and Voldemort now.
